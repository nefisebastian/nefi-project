                                    ...
                                    echo "<div class='col-lg-12'>";
                                        ...
                                        echo "</h2>";
                                            echo "<div class='row'>";
                                                ...
                                                echo "<form name='form1' method='POST' action='clase_registrar_producto.php'>";
                                                echo "<div class='clearfix'></div>";
                                                echo "<br>";
                                                echo "<div class='form-group col-lg-3'>";
                                                    echo "<input type='text' class='form-control' value='' name='nombre_producto' required>";
                                                echo "</div>";
                                                echo "<div class='form-group col-lg-3'>";
                                                ...
                                                echo "</div>";
                                                echo "<div class='form-group col-lg-3'>";
                                                    echo "<input type='text' class='form-control' value='' name='descripcion_producto' required>";
                                                echo "</div>";
                                                // Boton registrar //
                                                echo "<div class='form-group col-lg-3'>";                                                   
